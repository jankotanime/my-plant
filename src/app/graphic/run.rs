...
pub const WATER: PositionPrint = PositionPrint { print: "Podlej", y: 6 };
pub const CHANGE_NAME: PositionPrint = PositionPrint { print: "Zmień nazwę", y: 7 };
pub const DELETE: PositionPrint = PositionPrint { print: "Usuń", y: 8 };
pub const IMAGE: PositionPrint = PositionPrint { print: "Zmień obraz", y: 9 };
